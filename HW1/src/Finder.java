...
public class Finder {
    private void deleteLastKElements(int counter, ArrayList<Cell> cells) {
        ...
        for (int n = i - 1; n >= 0; n--) {
            if (!_fieldArray[n][j].isFree()) {
                if (_fieldArray[n][j].getColor() != playerColor) {
                    ...
                    ++counter;
                    if (n == 0) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
                deleteLastKElements(counter, cellsToColor);
                break;
            }
        }
        counter = 0;
        for (int n = i + 1; n < 8; n++) {
            if (!_fieldArray[n][j].isFree()) {
                if (_fieldArray[n][j].getColor() != playerColor) {
                    cellsToColor.add(_fieldArray[n][j]);
                    ++counter;
                    if (n == 7) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
        ...
        for (int m = j - 1; m >= 0; m--) {
            if (!_fieldArray[i][m].isFree()) {
                if (_fieldArray[i][m].getColor() != playerColor) {
                    ...
                    ++counter;
                    if (m == 0) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
        ...
        for (int m = j + 1; m < 8; m++) {
            if (!_fieldArray[i][m].isFree()) {
                if (_fieldArray[i][m].getColor() != playerColor) {
                    cellsToColor.add(_fieldArray[i][m]);
                    ++counter;
                    if (m == 7) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
        ...
        for (int k = 1; (i - k) >= 0 && (j + k) < 8; k++) {
            if (!_fieldArray[i - k][j + k].isFree()) {
                if (_fieldArray[i - k][j + k].getColor() != playerColor) {
                    ...
                    ++counter;
                    if ((i - k) == 0 && (j + k) == 7) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
        ...
        for (int k = 1; (i + k) < 8 && (j + k) < 8; k++) {
            if (!_fieldArray[i + k][j + k].isFree()) {
                if (_fieldArray[i + k][j + k].getColor() != playerColor) {
                    cellsToColor.add(_fieldArray[i + k][j + k]);
                    ++counter;
                    if ((i + k) == 7 && (j + k) == 7) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
        ...
        for (int k = 1; (i + k) < 8 && (j - k) >= 0; k++) {
            if (!_fieldArray[i + k][j - k].isFree()) {
                if (_fieldArray[i + k][j - k].getColor() != playerColor) {
                    cellsToColor.add(_fieldArray[i + k][j - k]);
                    ++counter;
                    if ((i - k) == 0 && (j - k) == 0) { deleteLastKElements(counter, cellsToColor); }
                } else {
                    break;
                }
            } else {
